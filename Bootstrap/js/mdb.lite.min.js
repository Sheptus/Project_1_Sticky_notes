...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function (t, e, i, n, a) {
            ...
            return e < 1 ? r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - s) * (2 * Math.PI) / o) * -.5 + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - s) * (2 * Math.PI) / o) * .5 + n + i
        },
        easeInBack: function (t, e, i, n, a, s) {
            return null == s && (s = 1.70158), n * (e /= a) * e * ((s + 1) * e - s) + i
        },
        easeOutBack: function (t, e, i, n, a, s) {
            return null == s && (s = 1.70158), n * ((e = e / a - 1) * e * ((s + 1) * e + s) + 1) + i
        },
        easeInOutBack: function (t, e, i, n, a, s) {
            return null == s && (s = 1.70158), (e /= a / 2) < 1 ? n / 2 * (e * e * ((1 + (s *= 1.525)) * e - s)) + i : n / 2 * ((e -= 2) * e * ((1 + (s *= 1.525)) * e + s) + 2) + i
        },
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function (t) {
                ...
                if (n) {
                    if (o)
                        for (; s > a && !1 !== i.apply(t[a], n); a++);
                    else
                        for (a in t)
                            if (!1 === i.apply(t[a], n)) break
                } else if (o)
                    for (; s > a && !1 !== i.call(t[a], a, t[a]); a++);
                else
                    for (a in t)
                ...
                var t, e, n, a, s, o, r = arguments[0] || {},
                    l = 1,
                    c = arguments.length,
                    u = !1;
                for ("boolean" == typeof r && (u = r, r = arguments[l] || {}, l++), "object" != typeof r && "function" !== i.type(r) && (r = {}), l === c && (r = this, l--); c > l; l++)
                    if (null != (s = arguments[l]))
                        for (a in s) t = r[a], r !== (n = s[a]) && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {}, r[a] = i.extend(u, o, n)) : void 0 !== n && (r[a] = n));
                return r
            }, i.queue = function (t, n, a) {
                if (t) {
                    n = (n || "fx") + "queue";
                    var s = i.data(t, n);
                    return a ? (!s || i.isArray(a) ? s = i.data(t, n, function (t, i) {
                        var n = i || [];
                ...
                i.each(t.nodeType ? [t] : t, function (t, n) {
                    ...
                    var a = i.queue(n, e),
                        s = a.shift();
                    "inprogress" === s && (s = a.shift()), s && ("fx" === e && a.unshift("inprogress"), s.call(n, function () {
                        i.dequeue(n, e)
                    }))
                })
            }, i.fn = i.prototype = {
            ...
            for (var a = {}, s = a.hasOwnProperty, o = a.toString, r = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < r.length; l++) a["[object " + r[l] + "]"] = r[l].toLowerCase();
        ...
        return function (t, e, i, n) {
            ...
            function o(t, i, n, a) {
                ...
                function l(t, e, i) {
                    return ((s(e, i) * t + o(e, i)) * t + r(e)) * t
                }

                function c(t, e, i) {
                    return 3 * s(e, i) * t * t + 2 * o(e, i) * t + r(e)
                }
                ...
                function d(e, i, a) {
                    var s, o, r = 0;
                    do {
                        (s = l(o = i + (a - i) / 2, t, n) - e) > 0 ? a = o : i = o
                    } while (Math.abs(s) > v && ++r < g);
                    return o
                }

                function h() {
                    S = !0, (t != i || n != a) && function () {
                        for (var e = 0; m > e; ++e) C[e] = l(e * b, t, n)
                    }()
                }
                var p = 4,
                    f = .001,
                ...
                var C = y ? new Float32Array(m) : new Array(m),
                    S = !1,
                    x = function (e) {
                        return S || h(), t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(function (e) {
                            for (var i = 0, a = 1, s = m - 1; a != s && C[a] <= e; ++a) i += b;
                            var o = i + (e - C[--a]) / (C[a + 1] - C[a]) * b,
                                r = c(o, t, n);
                            return r >= f ? u(e, o) : 0 == r ? o : d(e, i, i + b)
                        }(e), i, a)
                    };
            ...
            function r(t, e) {
                ...
                }.apply(null, t) : p.isArray(t) && 2 === t.length ? b.apply(null, t.concat([e])) : !(!p.isArray(t) || 4 !== t.length) && o.apply(null, t), !1 === i && (i = m.Easings[m.defaults.easing] ? m.defaults.easing : g), i
            }
                ...
                if (t) {
                    ...
                    for (var a = 0; i > a; a++)
                        if (m.State.calls[a]) {
                            ...
                            for (var g = Math.min((e - h) / d.duration, 1), b = 0, w = r.length; w > b; b++) {
                                var S = r[b],
                                    x = S.element;
                                if (s(x)) {
                                    var k = !1;
                                    if (d.display !== n && null !== d.display && "none" !== d.display) {
                                        if ("flex" === d.display) {
                                            u.each(["-webkit-box", "-moz-box", "-ms-flexbox", "-webkit-flex"], function (t, e) {
                                                y.setPropertyValue(x, "display", e)
                                            })
                                        }
                                        y.setPropertyValue(x, "display", d.display)
                                    }
                                    for (var $ in d.visibility !== n && "hidden" !== d.visibility && y.setPropertyValue(x, "visibility", d.visibility), S)
                                        if ("element" !== $) {
                                            var O, T = S[$],
                                                L = p.isString(T.easing) ? m.Easings[T.easing] : T.easing;
                                            if (1 === g) O = T.endValue;
                                            else {
                                                var E = T.endValue - T.startValue;
                                                if (O = T.startValue + E * L(g, d, E), !f && O === T.currentValue) continue
                                            }
                                            if (T.currentValue = O, "tween" === $) v = O;
                                            else {
                                                if (y.Hooks.registered[$]) {
                                                    var M = y.Hooks.getRoot($),
                                                        P = s(x).rootPropertyValueCache[M];
                                                    P && (T.rootPropertyValue = P)
                                                }
                                                var A = y.setPropertyValue(x, $, T.currentValue + (0 === parseFloat(O) ? "" : T.unitType), T.rootPropertyValue, T.scrollData);
                                                y.Hooks.registered[$] && (s(x).rootPropertyValueCache[M] = y.Normalizations.registered[M] ? y.Normalizations.registered[M]("extract", null, A[1]) : A[1]), "transform" === A[0] && (k = !0)
                                            }
                                        } d.mobileHA && s(x).transformCache.translate3d === n && (s(x).transformCache.translate3d = "(0px, 0px, 0px)", k = !0), k && y.flushTransformCache(x)
                                }
                            }
                            d.display !== n && "none" !== d.display && (m.State.calls[a][2].display = !1), d.visibility !== n && "hidden" !== d.visibility && (m.State.calls[a][2].visibility = !1), d.progress && d.progress.call(o[1], o[1], g, Math.max(0, h + d.duration - e), h, v), 1 === g && c(a)
                        }
                }
                m.State.isTicking && C(l)
            }

            function c(t, e) {
                if (!m.State.calls[t]) return !1;
                for (var i = m.State.calls[t][0], a = m.State.calls[t][1], o = m.State.calls[t][2], r = m.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
                    var h = i[c].element;
                    if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (u.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(h)[1])) && s(h)) {
                        s(h).isAnimating = !1, s(h).rootPropertyValueCache = {};
                        var p = !1;
                        u.each(y.Lists.transforms3D, function (t, e) {
                            var i = /^scale/.test(e) ? 1 : 0,
                                a = s(h).transformCache[e];
                            s(h).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(a) && (p = !0, delete s(h).transformCache[e])
                        }), o.mobileHA && (p = !0, delete s(h).transformCache.translate3d), p && y.flushTransformCache(h), y.Values.removeClass(h, "velocity-animating")
                    }
                    if (!e && o.complete && !o.loop && c === d - 1) try {
                        o.complete.call(a, a)
                    } catch (t) {
                        setTimeout(function () {
                            throw t
                    ...
                    r && !0 !== o.loop && r(a), s(h) && !0 === o.loop && !e && (u.each(s(h).tweensContainer, function (t, e) {
                ...
                m.State.calls[t] = !1;
                for (var f = 0, v = m.State.calls.length; v > f; f++)
            ...
            if (!(7 >= d)) {
                ...
                var b = function () {
                    ...
                    function i(i, n) {
                        var a = {
                            ...
                            o = e(i, .5 * n, s),
                            r = e(i, n, o),
                            l = 1 / 6 * (a.dx + 2 * (s.dx + o.dx) + r.dx),
                            c = 1 / 6 * (a.dv + 2 * (s.dv + o.dv) + r.dv);
                    ...
                    return function t(e, n, a) {
                        var s, o, r, l = {
                            ...
                            c = [0],
                            u = 0;
                        for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, a = a || null, l.tension = e, l.friction = n, (s = null !== a) ? o = (u = t(e, n)) / a * .016 : o = .016; r = i(r || l, o), c.push(1 + r.x), u += 16, Math.abs(r.x) > 1e-4 && Math.abs(r.v) > 1e-4;);
                        return s ? function (t) {
                ...
                var y = m.CSS = {
                    ...
                    Hooks: {
                        ...
                        register: function () {
                            ...
                            if (d)
                                for (i in y.Hooks.templates) {
                                    ...
                                    "Color" === a[0] && (a.push(a.shift()), s.push(s.shift()), y.Hooks.templates[i] = [a.join(" "), s.join(" ")])
                                }
                            for (i in y.Hooks.templates)
                                for (var t in a = (n = y.Hooks.templates[i])[0].split(" ")) {
                                    var o = i + a[t],
                                        r = t;
                                    y.Hooks.registered[o] = [i, r]
                                }
                        },
                        getRoot: function (t) {
                        ...
                        injectValue: function (t, e, i) {
                            ...
                            if (n) {
                                var a, s = n[0],
                                    o = n[1];
                                return (a = (i = y.Hooks.cleanRootPropertyValue(s, i)).toString().match(y.RegEx.valueSplit))[o] = e, a.join(" ")
                            }
                            return i
                        }
                    },
                    Normalizations: {
                        ...
                        register: function () {
                            9 >= d || m.State.isGingerbread || (y.Lists.transformsBase = y.Lists.transformsBase.concat(y.Lists.transforms3D));
                                    ...
                                    switch (t) {
                                        ...
                                        case "inject":
                                            ...
                                            switch (e.substr(0, e.length - 1)) {
                                                ...
                                                case "scal":
                                                case "scale":
                                                    m.State.isAndroid && s(i).transformCache[e] === n && 1 > a && (a = 1), o = !/(\d)$/i.test(a);
                                                    break;
                                                case "skew":
                                                    o = !/(deg|\d)$/i.test(a);
                                                    break;
                            ...
                            for (t = 0; t < y.Lists.colors.length; t++) ! function () {
                                ...
                                y.Normalizations.registered[e] = function (t, i, a) {
                                    switch (t) {
                                        ...
                                        case "extract":
                                            var s;
                                            if (y.RegEx.wrappedValueAlreadyExtracted.test(a)) s = a;
                                            else {
                                                var o, r = {
                                                    black: "rgb(0, 0, 0)",
                                                    blue: "rgb(0, 0, 255)",
                                                ...
                                                /^[A-z]+$/i.test(a) ? o = r[a] !== n ? r[a] : r.black : y.RegEx.isHex.test(a) ? o = "rgb(" + y.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = r.black), s = (o || a).toString().match(y.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                            }
                    ...
                    Names: {
                        ...
                        SVGAttribute: function (t) {
                            ...
                            return (d || m.State.isAndroid && !m.State.isChrome) && (e += "|transform"), new RegExp("^(" + e + ")$", "i").test(t)
                        },
                        prefixCheck: function (t) {
                            ...
                            for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
                                ...
                                if (a = 0 === i ? t : e[i] + t.replace(/^\w/, function (t) {
                                    ...
                                    }), p.isString(m.State.prefixElement.style[a])) return m.State.prefixMatches[t] = a, [a, !0]
                            }
                            return [t, !1]
                        }
                    },
                    ...
                    getPropertyValue: function (t, i, a, o) {
                        function r(t, i) {
                            ...
                            if (8 >= d) l = u.css(t, i);
                                ...
                                c = s(t) === n ? e.getComputedStyle(t, null) : s(t).computedStyle ? s(t).computedStyle : s(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), ("" === (l = 9 === d && "filter" === i ? c.getPropertyValue(i) : c[i]) || null === l) && (l = t.style[i]), a()
                            }
                        ...
                        if (y.Hooks.registered[i]) {
                            var c = i,
                                h = y.Hooks.getRoot(c);
                            a === n && (a = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])), y.Normalizations.registered[h] && (a = y.Normalizations.registered[h]("extract", t, a)), l = y.Hooks.extractValue(c, a)
                        } else if (y.Normalizations.registered[i]) {
                            var p, f;
                            "transform" !== (p = y.Normalizations.registered[i]("name", t)) && (f = r(t, y.Names.prefixCheck(p)[0]), y.Values.isCSSNullValue(f) && y.Hooks.templates[i] && (f = y.Hooks.templates[i][1])), l = y.Normalizations.registered[i]("extract", t, f)
                        }
                        if (!/^[\d-]/.test(l))
                            if (s(t) && s(t).isSVG && y.Names.SVGAttribute(i))
                                if (/^(height|width)$/i.test(i)) try {
                                    l = t.getBBox()[i]
                                } catch (t) {
                                    l = 0
                                } else l = t.getAttribute(i);
                                else l = r(t, y.Names.prefixCheck(i)[0]);
                    ...
                    setPropertyValue: function (t, i, n, a, o) {
                        ...
                        else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) y.Normalizations.registered[i]("inject", t, n), r = "transform", n = s(t).transformCache[i];
                        else {
                            if (y.Hooks.registered[i]) {
                                var l = i,
                                    c = y.Hooks.getRoot(i);
                                a = a || y.getPropertyValue(t, c), n = y.Hooks.injectValue(l, n, a), i = c
                            }
                            if (y.Normalizations.registered[i] && (n = y.Normalizations.registered[i]("inject", t, n), i = y.Normalizations.registered[i]("name", t)), r = y.Names.prefixCheck(i)[0], 8 >= d) try {
                                t.style[r] = n
                            } catch (t) {
                                m.debug && console.log("Browser does not support [" + n + "] for [" + r + "]")
                            } else s(t) && s(t).isSVG && y.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[r] = n;
                            m.debug >= 2 && console.log("Set " + i + " (" + r + "): " + n)
                        }
                        return [r, n]
                    },
                    flushTransformCache: function (t) {
                        ...
                        var i = "";
                        if ((d || m.State.isAndroid && !m.State.isChrome) && s(t).isSVG) {
                            var n = {
                            ...
                            var a, o;
                            u.each(s(t).transformCache, function (e) {
                ...
                y.Hooks.register(), y.Normalizations.register(), m.hook = function (t, e, i) {
                    var o = n;
                    return t = a(t), u.each(t, function (t, a) {
                        if (s(a) === n && m.init(a), i === n) o === n && (o = m.CSS.getPropertyValue(a, e));
                        else {
                            var r = m.CSS.setPropertyValue(a, e, i);
                            "transform" === r[0] && m.CSS.flushTransformCache(a), o = r
                        }
                    }), o
                };
                var w = function () {
                    ...
                    function o() {
                        function t(t) {
                            function h(t, e) {
                                var i = n,
                                    a = n,
                                    s = n;
                                return p.isArray(t) ? (i = t[0], !p.isArray(t[1]) && /^[\d-]/.test(t[1]) || p.isFunction(t[1]) || y.RegEx.isHex.test(t[1]) ? s = t[1] : (p.isString(t[1]) && !y.RegEx.isHex.test(t[1]) || p.isArray(t[1])) && (a = e ? t[1] : r(t[1], c.duration), t[2] !== n && (s = t[2]))) : i = t, e || (a = a || c.easing), p.isFunction(i) && (i = i.call(o, k, x)), p.isFunction(s) && (s = s.call(o, k, x)), [i || 0, a, s]
                            }
                            ...
                            function v() {
                                var t = {
                                    ...
                                    n = t.position === H.lastPosition && t.myParent === H.lastParent,
                                    a = t.fontSize === H.lastFontSize;
                                H.lastParent = t.myParent, H.lastPosition = t.position, H.lastFontSize = t.fontSize;
                                var r = 100,
                                    l = {};
                                if (a && n) l.emToPx = H.lastEmToPx, l.percentToPxWidth = H.lastPercentToPxWidth, l.percentToPxHeight = H.lastPercentToPxHeight;
                                else {
                                    ...
                                    m.init(c), t.myParent.appendChild(c), u.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                                        ...
                                        m.CSS.setPropertyValue(c, e, r + "%")
                                    }), m.CSS.setPropertyValue(c, "paddingLeft", r + "em"), l.percentToPxWidth = H.lastPercentToPxWidth = (parseFloat(y.getPropertyValue(c, "width", null, !0)) || 1) / r, l.percentToPxHeight = H.lastPercentToPxHeight = (parseFloat(y.getPropertyValue(c, "height", null, !0)) || 1) / r, l.emToPx = H.lastEmToPx = (parseFloat(y.getPropertyValue(c, "paddingLeft")) || 1) / r, t.myParent.removeChild(c)
                                }
                                return null === H.remToPx && (H.remToPx = parseFloat(y.getPropertyValue(i.body, "fontSize")) || 16), null === H.vwToPx && (H.vwToPx = parseFloat(e.innerWidth) / 100, H.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = H.remToPx, l.vwToPx = H.vwToPx, l.vhToPx = H.vhToPx, m.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), l
                            }
                            if (c.begin && 0 === k) try {
                                c.begin.call(g, g)
                            } catch (t) {
                            ...
                            if ("scroll" === O) {
                                var w, S, $, L = /^x$/i.test(c.axis) ? "Left" : "Top",
                                    E = parseFloat(c.offset) || 0;
                                c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container, $ = (w = c.container["scroll" + L]) + u(o).position()[L.toLowerCase()] + E) : c.container = null : (w = m.State.scrollAnchor[m.State["scrollProperty" + L]], S = m.State.scrollAnchor[m.State["scrollProperty" + ("Left" === L ? "Top" : "Left")]], $ = u(o).offset()[L.toLowerCase()] + E), d = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: w,
                                        currentValue: w,
                                    ...
                                    element: o
                                }, m.debug && console.log("tweensContainer (scroll): ", d.scroll, o)
                            } else if ("reverse" === O) {
                                if (!s(o).tweensContainer) return void u.dequeue(o, c.queue);
                                "none" === s(o).opts.display && (s(o).opts.display = "auto"), "hidden" === s(o).opts.visibility && (s(o).opts.visibility = "visible"), s(o).opts.loop = !1, s(o).opts.begin = null, s(o).opts.complete = null, C.easing || delete c.easing, C.duration || delete c.duration, c = u.extend({}, s(o).opts, c);
                                var M = u.extend(!0, {}, s(o).tweensContainer);
                                for (var P in M)
                                    if ("element" !== P) {
                                        var A = M[P].startValue;
                                        M[P].startValue = M[P].currentValue = M[P].endValue, M[P].endValue = A, p.isEmptyObject(C) || (M[P].easing = c.easing), m.debug && console.log("reverse tweensContainer (" + P + "): " + JSON.stringify(M[P]), o)
                                    } d = M
                            } else if ("start" === O) {
                                for (var W in s(o).tweensContainer && !0 === s(o).isAnimating && (M = s(o).tweensContainer), u.each(b, function (t, e) {
                                        if (RegExp("^" + y.Lists.colors.join("$|^") + "$").test(t)) {
                                            ...
                                            if (y.RegEx.isHex.test(a)) {
                                                for (var r = ["Red", "Green", "Blue"], l = y.Values.hexToRgb(a), c = o ? y.Values.hexToRgb(o) : n, u = 0; u < r.length; u++) {
                                                    var d = [l[u]];
                                                    s && d.push(s), c !== n && d.push(c[u]), b[t + r[u]] = d
                                                }
                                                delete b[t]
                                            }
                                        }
                                    ...
                                    var V = h(b[W]),
                                        ...
                                        D = V[1],
                                        X = V[2];
                                    W = y.Names.camelCase(W);
                                    var N = y.Hooks.getRoot(W),
                                        Y = !1;
                                    if (s(o).isSVG || "tween" === N || !1 !== y.Names.prefixCheck(N)[1] || y.Normalizations.registered[N] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(W) && !X && 0 !== _ && (X = 0), c._cacheValues && M && M[W] ? (X === n && (X = M[W].endValue + M[W].unitType), Y = s(o).rootPropertyValueCache[N]) : y.Hooks.registered[W] ? X === n ? (Y = y.getPropertyValue(o, N), X = y.getPropertyValue(o, W, Y)) : Y = y.Hooks.templates[N][1] : X === n && (X = y.getPropertyValue(o, W));
                                        var R, j, B, F = !1;
                                        if (X = (R = f(W, X))[0], B = R[1], _ = (R = f(W, _))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return F = e, ""
                                            }), j = R[1], X = parseFloat(X) || 0, _ = parseFloat(_) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(W) ? (_ /= 100, j = "em") : /^scale/.test(W) ? (_ /= 100, j = "") : /(Red|Green|Blue)$/i.test(W) && (_ = _ / 100 * 255, j = "")), /[\/*]/.test(F)) j = B;
                                        else if (B !== j && 0 !== X)
                                            if (0 === _) j = B;
                                            else {
                                                a = a || v();
                                                ...
                                                switch (B) {
                                                    case "%":
                                                        X *= "x" === q ? a.percentToPxWidth : a.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (j) {
                                                    case "%":
                                                        X *= 1 / ("x" === q ? a.percentToPxWidth : a.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                        ...
                                        d[W] = {
                                            ...
                                            unitType: j,
                                            easing: D
                                        }, m.debug && console.log("tweensContainer (" + W + "): " + JSON.stringify(d[W]), o)
                                    } else m.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                                }
                                d.element = o
                            }
                            d.element && (y.Values.addClass(o, "velocity-animating"), I.push(d), "" === c.queue && (s(o).tweensContainer = d, s(o).opts = c), s(o).isAnimating = !0, k === x - 1 ? (m.State.calls.push([I, g, c, null, T.resolver]), !1 === m.State.isTicking && (m.State.isTicking = !0, l())) : k++)
                        }
                        var a, o = this,
                            c = u.extend({}, m.defaults, C),
                            d = {};
                        switch (s(o) === n && m.init(o), parseFloat(c.delay) && !1 !== c.queue && u.queue(o, c.queue, function (t) {
                            m.velocityQueueEntryFlag = !0, s(o).delayTimer = {
                        ...
                        }!1 !== m.mock && (!0 === m.mock ? c.duration = c.delay = 1 : (c.duration *= parseFloat(m.mock) || 1, c.delay *= parseFloat(m.mock) || 1)), c.easing = r(c.easing, c.duration), c.begin && !p.isFunction(c.begin) && (c.begin = null), c.progress && !p.isFunction(c.progress) && (c.progress = null), c.complete && !p.isFunction(c.complete) && (c.complete = null), c.display !== n && null !== c.display && (c.display = c.display.toString().toLowerCase(), "auto" === c.display && (c.display = m.CSS.Values.getDisplayType(o))), c.visibility !== n && null !== c.visibility && (c.visibility = c.visibility.toString().toLowerCase()), c.mobileHA = c.mobileHA && m.State.isMobile && !m.State.isGingerbread, !1 === c.queue ? c.delay ? setTimeout(t, c.delay) : t() : u.queue(o, c.queue, function (e, i) {
                            return !0 === i ? (T.promise && T.resolver(g), !0) : (m.velocityQueueEntryFlag = !0, void t())
                        }), "" !== c.queue && "fx" !== c.queue || "inprogress" === u.queue(o)[0] || u.dequeue(o)
                    }
                    var d, h, f, g, b, C, S = arguments[0] && (arguments[0].p || u.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || p.isString(arguments[0].properties));
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = S ? arguments[0].elements || arguments[0].e : arguments[0]), g = a(g)) {
                        S ? (b = arguments[0].properties || arguments[0].p, C = arguments[0].options || arguments[0].o) : (b = arguments[f], C = arguments[f + 1]);
                        var x = g.length,
                            k = 0;
                        if (!/^(stop|finish)$/i.test(b) && !u.isPlainObject(C)) {
                            C = {};
                            for (var $ = f + 1; $ < arguments.length; $++) p.isArray(arguments[$]) || !/^(fast|normal|slow)$/i.test(arguments[$]) && !/^\d/.test(arguments[$]) ? p.isString(arguments[$]) || p.isArray(arguments[$]) ? C.easing = arguments[$] : p.isFunction(arguments[$]) && (C.complete = arguments[$]) : C.duration = arguments[$]
                        }
                        var O, T = {
                            promise: null,
                            resolver: null,
                        ...
                        switch (d && m.Promise && (T.promise = new m.Promise(function (t, e) {
                            ...
                            case "stop":
                                ...
                                return u.each(m.State.calls, function (t, e) {
                                    e && u.each(e[1], function (i, a) {
                                        var o = C === n ? "" : C;
                                        return !0 !== o && e[2].queue !== o && (C !== n || !1 !== e[2].queue) || void u.each(g, function (i, n) {
                                            n === a && ((!0 === C || p.isString(C)) && (u.each(u.queue(n, p.isString(C) ? C : ""), function (t, e) {
                                                p.isFunction(e) && e(null, !0)
                                            }), u.queue(n, p.isString(C) ? C : "", [])), "stop" === b ? (s(n) && s(n).tweensContainer && !1 !== o && u.each(s(n).tweensContainer, function (t, e) {
                                                e.endValue = e.currentValue
                                            }), L.push(t)) : "finish" === b && (e[2].duration = 1))
                                        })
                                    })
                                }), "stop" === b && (u.each(L, function (t, e) {
                                    c(e, !0)
                                }), T.promise && T.resolver(g)), t();
                            default:
                                if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                                    if (p.isString(b) && m.Redirects[b]) {
                                        var E = (W = u.extend({}, C)).duration,
                                            M = W.delay || 0;
                                        return !0 === W.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function (t, e) {
                                            parseFloat(W.stagger) ? W.delay = M + parseFloat(W.stagger) * t : p.isFunction(W.stagger) && (W.delay = M + W.stagger.call(e, t, x)), W.drag && (W.duration = parseFloat(E) || (/^(callout|transition)/.test(b) ? 1e3 : v), W.duration = Math.max(W.duration * (W.backwards ? 1 - t / x : (t + 1) / x), .75 * W.duration, 200)), m.Redirects[b].call(e, e, W || {}, t, x, g, T.promise ? T : n)
                                        }), t()
                                    }
                                    var P = "Velocity: First argument (" + b + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                    return T.promise ? T.rejecter(new Error(P)) : console.log(P), t()
                                }
                                O = "start"
                        }
                        var A, W, H = {
                        ...
                        if (u.each(g, function (t, e) {
                                p.isNode(e) && o.call(e)
                            }), (W = u.extend({}, m.defaults, C)).loop = parseInt(W.loop), A = 2 * W.loop - 1, W.loop)
                            for (var V = 0; A > V; V++) {
                                var _ = {
                                    delay: W.delay,
                                    progress: W.progress
                                };
                                V === A - 1 && (_.display = W.display, _.visibility = W.visibility, _.complete = W.complete), w(g, "reverse", _)
                            }
                        return t()
                    }
                };
                ...
                return m.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
                    ...
                    m.Redirects["fade" + e] = function (t, i, a, s, o, r) {
                        var l = u.extend({}, i),
                            c = {
                                opacity: "In" === e ? 1 : 0
                            },
                            d = l.complete;
                        l.complete = a !== s - 1 ? l.begin = null : function () {
                            d && d.call(o, o), r && r.resolver(o)
    ...
    function (t, e) {
        ...
        return {
            init: function (i, n) {
                ...
                for (var a = [].slice.call(document.querySelectorAll(i)), s = [].slice.call(document.querySelectorAll(n)), u = 0, d = a.length; u < d; u++) {
                    var h = a[u];
                    Object.defineProperty(h, "bsCustomFileInput", {
                        ...
                        writable: !0
                    }), o.call(h), h.addEventListener(c, o)
                }
                for (var p = 0, f = s.length; p < f; p++) s[p].addEventListener(l, r), Object.defineProperty(s[p], "bsCustomFileInput", {
                    value: !0,
                    writable: !0
                })
            },
            destroy: function () {
                for (var e = [].slice.call(document.querySelectorAll(t.FORM)).filter(function (t) {
                    ...
                    var u = i[a];
                    n(u), u.bsCustomFileInput = void 0, u.removeEventListener(c, o)
                }
                for (var d = 0, h = e.length; d < h; d++) e[d].removeEventListener(l, r), e[d].bsCustomFileInput = void 0
            }
        }
            ...
            return {
                init: function () {
                        ...
                        t(".wow").each(function () {
                            if ("visible" != t(this).css("visibility") && (i + n - 100 > a(this) && n < a(this) || i + n - 100 > a(this) + t(this).height() && n < a(this) + t(this).height() || i + n == t(document).height() && a(this) + 100 > t(document).height())) {
                                ...
                                if (o) {
                                    ...
                                    l = 1e3 * t(this).css("animation-duration").slice(0, -1), r = this;
                                    setTimeout(function () {
                                        t(r).removeClass("animated")
                                    }, l)
                                }
                    ...
                    t(".wow").each(function () {
                        ...
                        var e, s;
                        i ? (e = window.innerHeight, s = window.scrollY, t(".wow.animated").each(function () {
                            if (e + s - 100 > a(this) && s > a(this) + 100 || e + s - 100 < a(this) && s < a(this) + 100 || a(this) + t(this).height > t(document).height() - 100) t(this).removeClass("animated"), t(this).css({
                                "animation-name": "none"
                            }), t(this).css({
                                visibility: "hidden"
                            });
    ...
    function (t, e) {
        ...
        function s(t) {
            var n, s = i.call(t);
            return "[object String]" === s ? e(t) : a(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(s) && t.hasOwnProperty("length") ? t : a(n = t) && n.nodeType > 0 ? [t] : []
        }
        ...
        var l = {
                ...
                show: function (t, e, i) {
                    ...
                    var a = o(e),
                        s = 0,
                        c = 0;
                    "touches" in t && t.touches.length ? (s = t.touches[0].pageY - a.top, c = t.touches[0].pageX - a.left) : (s = t.pageY - a.top, c = t.pageX - a.left), c = c >= 0 ? c : 0, s = s >= 0 ? s : 0;
                    var u = "scale(" + e.clientWidth / 100 * 3 + ")",
                        d = "translate(0,0)";
                    i && (d = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", c), n.setAttribute("data-y", s), n.setAttribute("data-scale", u), n.setAttribute("data-translate", d);
                    var h = {
                        top: s + "px",
                        left: c + "px"
                    };
                    n.classList.add("waves-notransition"), n.setAttribute("style", r(h)), n.classList.remove("waves-notransition"), h["-webkit-transform"] = u + " " + d, h["-moz-transform"] = u + " " + d, h["-ms-transform"] = u + " " + d, h["-o-transform"] = u + " " + d, h.transform = u + " " + d, h.opacity = "1";
                    var p = "mousemove" === t.type ? 2500 : l.duration;
                    h["-webkit-transition-duration"] = p + "ms", h["-moz-transition-duration"] = p + "ms", h["-o-transition-duration"] = p + "ms", h["transition-duration"] = p + "ms", n.setAttribute("style", r(h))
                },
                hide: function (t, e) {
                    for (var i = (e = e || this).getElementsByClassName("waves-rippling"), a = 0, s = i.length; a < s; a++) u(t, e, i[a]);
            ...
            if (i) {
                ...
                setTimeout(function () {
                    var t = {
                        ...
                        "-webkit-transform": s + " " + o,
                        "-moz-transform": s + " " + o,
                        "-ms-transform": s + " " + o,
                        "-o-transform": s + " " + o,
                        transform: s + " " + o
                    };
                    i.setAttribute("style", r(t)), setTimeout(function () {
                        try {
                            e.removeChild(i)
                        } catch (t) {
                            return !1
            ...
            if (null !== e) {
                ...
                if (d.registerEvent(t), "touchstart" === t.type && l.delay) {
                    var i = !1,
                        ...
                        s = function (n) {
                            a && (clearTimeout(a), a = null, l.show(t, e)), i || (i = !0, l.hide(n, e)), r()
                        },
                        o = function (t) {
                            a && (clearTimeout(a), a = null), s(t), r()
                        };
                    e.addEventListener("touchmove", o, !1), e.addEventListener("touchend", s, !1), e.addEventListener("touchcancel", s, !1);
                    var r = function () {
                        e.removeEventListener("touchmove", o), e.removeEventListener("touchend", s), e.removeEventListener("touchcancel", s)
                    }
        ...
        return t.init = function (t) {
            ...
            var n, a;
            t = s(t), "[object Array]" === i.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
            for (var o = 0, r = t.length; o < r; o++) a = (n = t[o]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(a) && (c[a](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
        }, t.ripple = function (t, e) {
            var i = (t = s(t)).length;
            if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, i)
                for (var n, a, r, c = {}, u = 0, d = {
                        type: "mousedown",
                        button: 1
                    }, h = function (t, e) {
                        return function () {
                    ...
                    if (n = t[u], a = e.position || {
                            x: n.clientWidth / 2,
                            y: n.clientHeight / 2
                        }, r = o(n), c.x = r.left + a.x, c.y = r.top + a.y, d.pageX = c.x, d.pageY = c.y, l.show(d, n), e.wait >= 0 && null !== e.wait) {
                        setTimeout(h({
                            type: "mouseup",
                            button: 1
                        }, n), e.wait)
            ...
            for (var e = {
                    type: "mouseup",
                    button: 1
                }, i = 0, n = (t = s(t)).length; i < n; i++) l.hide(e, t[i])
...
! function (t) {
        ...
        s = function (t) {
            if (t.hasClass("validate")) {
                ...
                if (i && n) t.removeClass("valid").removeClass("invalid");
                    ...
                    var a = t.is(":valid"),
                        s = Number(t.attr("length")) || 0;
                    a && (!s || s > e.length) ? t.removeClass("invalid").addClass("valid") : t.removeClass("valid").addClass("invalid")
                }
            }
        },
        o = function () {
            ...
            if (e.val().length) {
                ...
                i.html(s), i.css("width", e.is(":visible") ? e.width() : t(window).width() / 2), e.css("height", i.height())
            }
        };
    t(n).each(function (e, i) {
        var n = t(i),
            s = n.siblings("label, i");
        a(n), i.validity.badInput && s.addClass("active")
        ...
        n && a && o && i.siblings("label, i").removeClass("active"), s(i)
    ...
    t(".materialize-textarea").each(o), r.on("keyup keydown", ".materialize-textarea", o)
}(jQuery);
        ...
        t(document).on("click.card", ".card", function (e) {
            if (t(this).find(".card-reveal").length) {
                var i = t(e.target),
                    ...
                    s = i.is(".card .activator"),
                    o = i.is(".card .activator i");
                n || a ? t(this).find(".card-reveal").velocity({
                    translateY: 0
                }, {
                    duration: 225,
                    queue: !1,
                ...
                }) : (s || o) && t(this).find(".card-reveal").css({
                    display: "block"
    ...
    function (t) {
        ...
        t.fn.characterCounter = function () {
            return this.each(function () {
                var n, a;
                void 0 !== t(this).attr("length") && (t(this).on("input", e), t(this).on("focus", e), t(this).on("blur", i), n = t(this), a = t("<span/>").addClass("character-counter").css("float", "right").css("font-size", "12px").css("height", 1), n.parent().append(a))
            })
        ...
        t(["jquery"], function (t) {
            return function () {
                var e, i, n, a = 0,
                    ...
                    o = {
                        clear: function (i, n) {
                            ...
                            e || r(a);
                            l(i, a, n) || function (i) {
                                for (var n = e.children(), a = n.length - 1; a >= 0; a--) l(t(n[a]), i)
                            }(a)
                        },
                        remove: function (i) {
                            var n = d();
                ...
                function u(i) {
                    ...
                    if (void 0 !== i.optionsOverride && (s = t.extend(s, i.optionsOverride), o = i.optionsOverride.iconClass || o), ! function (t, e) {
                        ...
                        return i.iconClass && u.addClass(s.toastClass).addClass(o), i.title && (p.append(i.title).addClass(s.titleClass), u.append(p)), i.message && (f.append(i.message).addClass(s.messageClass), u.append(f)), s.closeButton && (g.addClass("md-toast-close-button").attr("role", "button"), u.prepend(g)), s.progressBar && (v.addClass("md-toast-progress"), u.prepend(v)), s.newestOnTop ? e.prepend(u) : e.append(u), u.hide(), u[s.showMethod]({
                                duration: s.showDuration,
                                easing: s.showEasing,
                                complete: s.onShown
                            }), s.timeOut > 0 && (l = setTimeout(y, s.timeOut), m.maxHideTime = parseFloat(s.timeOut), m.hideEta = (new Date).getTime() + m.maxHideTime, s.progressBar && (m.intervalId = setInterval(S, 10))),
                            function () {
                                u.hover(C, w), !s.onclick && s.tapToDismiss && u.click(y);
                                s.closeButton && g && g.click(function (t) {
                            ...
                            }(), c(b), s.debug && console && console.log(b), u
                    }

                    function y(e) {
                        if (!t(":focus", u).length || e) return clearTimeout(m.intervalId), u[s.hideMethod]({
                            duration: s.hideDuration,
                            easing: s.hideEasing,
                            complete: function () {
                                h(u), s.onHidden && "hidden" !== b.state && s.onHidden(), b.state = "hidden", b.endTime = new Date, c(b)
                            }
                        })
                    }

                    function w() {
                        (s.timeOut > 0 || s.extendedTimeOut > 0) && (l = setTimeout(y, s.extendedTimeOut), m.maxHideTime = parseFloat(s.extendedTimeOut), m.hideEta = (new Date).getTime() + m.maxHideTime)
                    }

                    function C() {
                        clearTimeout(l), m.hideEta = 0, u.stop(!0, !0)[s.showMethod]({
                            duration: s.showDuration,
                            easing: s.showEasing
                        })
                    }
                ...
                function h(t) {
                    e || (e = r()), t.is(":visible") || (t.remove(), t = null, 0 === e.children().length && (e.remove(), n = void 0))
                }
            }()
        })
        ...
        t.fn.scrollTo = function (e) {
            ...
            this.each(function () {
                var i = t(this),
                    ...
                    a = !1,
                    s = t("#".concat(i.attr("data-activates")));
                ...
                function r(e) {
                    "focus" === e && (a = !0), o(), s.addClass("active"), i.addClass("active"), !0 === n.constrain_width ? s.css("width", i.outerWidth()) : s.css("white-space", "nowrap");
                    ...
                    var v = 0,
                        g = i.parent();
                    if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (v = g[0].scrollTop), c + s.innerWidth() > t(window).width() ? d = "right" : c - s.innerWidth() + i.innerWidth() < 0 && (d = "left"), u + s.innerHeight() > r)
                        if (u + l - s.innerHeight() < 0) {
                            var m = r - u - f;
                            s.css("max-height", m)
                        } else f || (f += l), f -= s.innerHeight();
                    if ("left" === d) h = n.gutter, p = i.position().left + h;
                    else if ("right" === d) {
                        p = i.position().left + i.outerWidth() - s.outerWidth() + (h = -n.gutter)
                    }
                    s.css({
                        position: "absolute",
                        top: i.position().top + f + v,
                        left: p
                ...
                function l() {
                    a = !1, s.fadeOut(n.outDuration), s.removeClass("active"), i.removeClass("active"), setTimeout(function () {
                        s.css("max-height", "")
                    }, n.outDuration)
                }
                if (o(), i.after(s), n.hover) {
                    var c = !1;
                    i.unbind("click.".concat(i.attr("id"))), i.on("mouseenter", function () {
                        !1 === c && (r(), c = !0)
                    }), i.on("mouseleave", function (e) {
                        var i = e.toElement || e.relatedTarget;
                        t(i).closest(".dropdown-content").is(s) || (s.stop(!0, !0), l(), c = !1)
                    }), s.on("mouseleave", function (e) {
                        var n = e.toElement || e.relatedTarget;
                        t(n).closest(".dropdown-button").is(i) || (s.stop(!0, !0), l(), c = !1)
                    })
                } else i.unbind("click.".concat(i.attr("id"))), i.bind("click.".concat(i.attr("id")), function (e) {
                    a || (i[0] !== e.currentTarget || i.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? i.hasClass("active") && (l(), t(document).unbind("click.".concat(s.attr("id"), " touchstart.").concat(s.attr("id")))) : (e.preventDefault(), r("click")), s.hasClass("active") && t(document).bind("click.".concat(s.attr("id"), " touchstart.").concat(s.attr("id")), function (e) {
                        s.is(e.target) || i.is(e.target) || i.find(e.target).length || (l(), t(document).unbind("click.".concat(s.attr("id"), " touchstart.").concat(s.attr("id"))))
                    }))
                });
...
function dropdownEffectData(t) {
    ...
    return s.height > 0 && (e = s.data("dropdown-in") || null, i = s.data("dropdown-out") || null), {
        ...
        dropdown: n,
        dropdownMenu: a,
        effectIn: a.data("dropdown-in") || e,
        effectOut: a.data("dropdown-out") || i
    }
}
...
dropdownSelectors.on({
    ...
    function (t) {
        ...
        t(".fixed-action-btn:not(.smooth-scroll) > .btn-floating").on("click", function (a) {
            if (!t(e).hasClass("smooth-scroll")) return a.preventDefault(), s = t(".fixed-action-btn"), (o = s).hasClass("active") ? n(o) : i(o), !1;
            var s, o
        })
    }(jQuery),
    function (t) {
            ...
            d = function () {
                function d(h, p) {
                    _classCallCheck(this, d), this.defaults = {
                        ...
                        timeDurationOpen: n,
                        timeDurationClose: a,
                        timeDurationOverlayOpen: s,
                        timeDurationOverlayClose: o,
                        easingOpen: r,
                        easingClose: l,
                        showOverlay: c,
                        showCloseButton: u
                    ...
                    value: function (t) {
                        if ("touchend" === t.type) {
                            ...
                            var i = this.calculateTouchVelocityX(),
                                n = e.clientX,
                                a = n - this.options.MENU_WIDTH,
                                s = n - this.options.MENU_WIDTH / 2;
                            a > 0 && (a = 0), s < 0 && (s = 0), "left" === this.options.edge ? (this.menuOut && i <= .3 || i < -.5 ? (0 !== a && this.translateMenuX([0, a], "300"), this.showSidenavOverlay()) : (!this.menuOut || i > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, a], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                                width: "10px",
                                right: "",
                                left: 0
                            })) : this.menuOut && i >= -.3 || i > .5 ? (this.translateMenuX([0, s], "300"), this.showSidenavOverlay(), this.$dragTarget.css({
                                width: "50%",
                                right: "",
                                left: 0
                            })) : (!this.menuOut || i < -.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10, s], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                                width: "10px",
                                right: 0,
                                left: ""
                            }))
                    ...
                    value: function (t) {
                        if ("touch" === t.gesture.pointerType) {
                            var e = t.gesture.velocityX,
                                ...
                                a = i - this.options.MENU_WIDTH / 2;
                            n > 0 && (n = 0), a < 0 && (a = 0), "left" === this.options.edge ? (this.menuOut && e <= .3 || e < -.5 ? (0 !== n && this.translateMenuX([0, n], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, n], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                                width: "10px",
                                right: "",
                                left: 0
                            })) : this.menuOut && e >= -.3 || e > .5 ? (this.translateMenuX([0, a], "300"), this.showSidenavOverlay(), this.$dragTarget.css({
                                width: "50%",
                                right: "",
                                left: 0
                            })) : (!this.menuOut || e < -.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10, a], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                                width: "10px",
                                right: 0,
                                left: ""
                            }))
    ...
    function (t) {
        t.fn.collapsible = function (e) {
            ...
            return e = t.extend(i, e), this.each(function () {
                ...
                i.off("click.collapse", ".collapsible-header"), r.off("click.collapse"), e.accordion || "accordion" === l || void 0 === l ? ((r = i.find("> li > .collapsible-header")).on("click.collapse", function (e) {
                    var a = t(e.target);
                    s(a) && (a = o(a)), a.toggleClass("active"), n(i, a)
                }), n(i, r.filter(".active").first())) : r.each(function () {
                    t(this).on("click.collapse", function (e) {
                        var i = t(e.target);
                        s(i) && (i = o(i)), i.toggleClass("active"), a(i)
                    }), t(this).hasClass("active") && a(t(this))
                })
            })
    ...
    function (t) {
        ...
        t(document).on("change", i, function () {
        ...
        }), t(document).on("input mousedown touchstart", i, function (s) {
            var o = t(this),
                r = o.siblings(".thumb"),
                l = o.outerWidth();
            if (!r.length && function () {
                    var e = t(n);
                    t(i).after(e)
                }(), r.find(".value").html(o.val()), a = !0, o.addClass("active"), r.hasClass("active") || r.velocity({
                    height: "30px",
                    width: "30px",
                    top: "-20px",
                    marginLeft: "-15px"
                ...
                var c = void 0 === s.pageX || null === s.pageX;
                (e = c ? s.originalEvent.touches[0].pageX - t(this).offset().left : s.pageX - t(this).offset().left) < 0 ? e = 0 : e > l && (e = l), r.addClass("active").css("left", e)
            }
            r.find(".value").html(o.val())
            ...
            if (a) {
                ...
                n < 0 ? n = 0 : n > o && (n = o), s.addClass("active").css("left", n), s.find(".value").html(s.siblings(i).val())
            }
    ...
    function (t) {
        t(document).on("change", '.file-field input[type="file"]', function (e) {
            ...
            Array.isArray(a) ? a.forEach(function (t) {
                return s.push(t.name)
            }) : Object.keys(a).forEach(function (t) {
                s.push(a[t].name)
            }), n.val(s.join(", ")), n.trigger("change")
        })
    }(jQuery),
    function (t) {
        var e, i = function () {
            ...
            return _createClass(e, [{
                ...
                value: function () {
                    ...
                    this.$nativeSelectChildren.each(function (i, n) {
                        var a = t(n);
                        if (a.is("option")) e.buildSingleOption(a, e.isMultiple ? "multiple" : "");
                        else if (a.is("optgroup")) {
                            var s = t('<li class="optgroup"><span>'.concat(a.attr("label"), "</span></li>"));
                            e.$materialOptionsList.append(s), a.children("option").each(function (i, n) {
                ...
                value: function (e, i) {
                    var n = e.is(":disabled") ? "disabled" : "",
                        ...
                        s = e.data("icon"),
                        o = e.data("fas") ? '<i class="fa-pull-right m-2 fas fa-'.concat(e.data("fas"), " ").concat([...this.options.fasClasses].join(""), '"></i> ') : "",
                        r = e.data("far") ? '<i class="fa-pull-right m-2 far fa-'.concat(e.data("far"), " ").concat([...this.options.farClasses].join(""), '"></i> ') : "",
                        l = e.data("fab") ? '<i class="fa-pull-right m-2 fab fa-'.concat(e.data("fab"), " ").concat([...this.options.fabClasses].join(""), '"></i> ') : "",
                        c = e.attr("class"),
                        u = s ? '<img alt="" src="'.concat(s, '" class="').concat(c, '">') : "",
                        d = this.isMultiple ? '<input type="checkbox" class="form-check-input" '.concat(n, "/><label></label>") : "";
                    this.$materialOptionsList.append(t('<li class="'.concat(n, " ").concat(a, " ").concat(this.options.copyClassesOption ? c : "", ' ">').concat(u, '<span class="filtrable">').concat(d, " ").concat(e.html(), " ").concat(o, " ").concat(r, " ").concat(l, "</span></li>")))
                }
            }, {
                ...
                value: function (e, i, n) {
                    ...
                    if (!a.hasClass("disabled") && !a.hasClass("optgroup")) {
                        ...
                        if (this.isMultiple) {
                            ...
                            var o = Boolean(this.$nativeSelect.find("optgroup").length),
                                r = this._isToggleAllPresent() ? a.index() - 1 : a.index();
                            s = this.isSearchable && o ? this._toggleSelectedValue(r - a.prevAll(".optgroup").length - 1) : this.isSearchable ? this._toggleSelectedValue(r - 1) : o ? this._toggleSelectedValue(r - a.prevAll(".optgroup").length) : this._toggleSelectedValue(r), this._isToggleAllPresent() && this._updateToggleAllOption(), this.$materialSelect.trigger("focus")
                        } else this.$materialOptionsList.find("li").removeClass("active"), a.toggleClass("active"), this.$materialSelect.val(a.text().replace(/  +/g, " ").trim()), this.$materialSelect.trigger("close");
                        this._selectSingleOption(a), this.$nativeSelect.data("stop-refresh", !0), this.$nativeSelect.find("option").eq(e).prop("selected", s), this.$nativeSelect.removeData("stop-refresh"), this._triggerChangeOnNativeSelect(), this.mainLabel.prev().find("input").hasClass("select-dropdown") && this.mainLabel.prev().find("input.select-dropdown").val().length > 0 && this.mainLabel.addClass("active"), "function" == typeof this.options && this.options(), a.hasClass("li-added") && this.$materialOptionsList.append(this.buildSingleOption(a, ""))
                    }
                }
            }, {
                ...
                value: function (e) {
                    ...
                    if (t("ul.select-dropdown").not(this.$materialOptionsList.get(0)).is(":visible") && t("input.select-dropdown").trigger("close"), this.mainLabel.addClass("active"), !this.$materialOptionsList.is(":visible")) {
                        ...
                        var n = i.val(),
                            a = this.$materialOptionsList.find("li").filter(function () {
                                return t(this).text().toLowerCase() === n.toLowerCase()
                            })[0];
                        this._selectSingleOption(a)
                    }
                ...
                value: function (e) {
                    var i = this,
                        ...
                        a = !t(n).prop("checked");
                    t(n).prop("checked", a), this.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").each(function (e, n) {
                        var s = t(n).find('input[type="checkbox"]');
                        a && s.is(":checked") || !a && !s.is(":checked") || t(n).is(":hidden") || t(n).is(".disabled") || (s.prop("checked", a), i.$nativeSelect.find("option").eq(e).prop("selected", a), a ? t(n).removeClass("active") : t(n).addClass("active"), i._toggleSelectedValue(e), i._selectOption(n), i._setValueToMaterialSelect())
                ...
                value: function (e) {
                    var i = t(e.target),
                        ...
                        a = e.which === this.keyCodes.esc,
                        s = e.which === this.keyCodes.enter,
                        o = s && e.shiftKey,
                        r = e.which === this.keyCodes.arrowUp,
                        l = e.which === this.keyCodes.arrowDown,
                        c = this.$materialOptionsList.is(":visible");
                    n ? this._handleTabKey(i) : !l || c ? s && !c || (e.preventDefault(), o ? this._handleEnterWithShiftKey(i) : s ? this._handleEnterKey(i) : l ? this._handleArrowDownKey() : r ? this._handleArrowUpKey() : a ? this._handleEscKey(i) : this._handleLetterKey(e)) : i.trigger("open")
                }
            }, {
                key: "_handleTabKey",
                value: function (t) {
                ...
                value: function () {
                    var e = this,
                        ...
                        a = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all").last(),
                        s = this.$materialOptionsList.find("li.selected").length > 0,
                        o = s ? this.$materialOptionsList.find("li.selected").first() : n,
                        r = o.next("li:visible:not(.disabled, .select-toggle-all)"),
                        l = r;
                    i.each(function (n, a) {
                        t(a).hasClass(e.keyboardActiveClass) && (r = i.eq(n + 1), l = i.eq(n))
                    });
                    var c = o.is(a) || !s ? o : r;
                ...
                value: function () {
                    var e = this,
                        ...
                        a = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all").last(),
                        s = this.$materialOptionsList.find("li.selected").length > 0,
                        o = s ? this.$materialOptionsList.find("li.selected").first() : a,
                        r = o.prev("li:visible:not(.disabled, .select-toggle-all)"),
                        l = r;
                    i.each(function (n, a) {
                        t(a).hasClass(e.keyboardActiveClass) && (r = i.eq(n - 1), l = i.eq(n))
                    });
                ...
                value: function (e) {
                    ...
                    if (this._escapeKeyboardActiveOptions(), this.isSearchable) {
                        var n = e.which > 46 && e.which < 91,
                            a = e.which > 93 && e.which < 106,
                            s = 8 === e.which;
                        (n || a) && this.$searchInput.find("input").val(e.key).focus(), s && this.$searchInput.find("input").val("").focus()
                    } else {
                        var o = "",
                        ...
                        if (r && -1 === l.indexOf(e.which)) {
                            ...
                            var c = this.$materialOptionsList.find("li").filter(function (e, i) {
                                return t(i).text().toLowerCase().includes(o)
                            }).first();
                ...
                value: function (e) {
                    var i = t(e.target),
                        ...
                        o = s && e.shiftKey,
                        r = e.which === this.keyCodes.arrowUp;
                    if (e.which === this.keyCodes.arrowDown || n || a || r) return this.$materialSelect.focus(), void this._handleArrowDownKey();
                    var l = i.closest("ul"),
                        c = i.val(),
                    ...
                    if (u.each(function () {
                        ...
                        }), s) return this.isEditable && !d ? void this.addNewOption() : (o && this._handleEnterWithShiftKey(i), void this.$materialSelect.trigger("open"));
    ...
    function (t, e) {
        ...
        function o(t, e) {
            ...
            i.contains(n) ? clearTimeout(m[e]) : i.add(n)
        }
        ...
        function f(t, e) {
            function i(e) {
                v[h] = m + y * (e[l] - b), o(t, p), x(t), e.stopPropagation(), e.preventDefault()
            }

            function n() {
                r(t, p), t[f].classList.remove(g.state.clicking), t.event.unbind(t.ownerDocument, "mousemove", i)
            }
            var a = e[0],
                s = e[1],
                l = e[2],
            ...
            t.event.bind(t[u], "mousedown", function (e) {
                m = v[h], b = e[l], y = (t[s] - t[a]) / (t[c] - t[d]), t.event.bind(t.ownerDocument, "mousemove", i), t.event.once(t.ownerDocument, "mouseup", n), t[f].classList.add(g.state.clicking), e.stopPropagation(), e.preventDefault()
            })
        }
        ...
        var C = function (t, e, i, n, a) {
                var s;
                if (void 0 === n && (n = !0), void 0 === a && (a = !1), "top" === e) s = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                else {
                    ...
                    var p = t.element;
                    t.reach[u] = null, p[r] < 1 && (t.reach[u] = "start"), p[r] > t[s] - t[o] - 1 && (t.reach[u] = "end"), e && (p.dispatchEvent(c("ps-scroll-" + u)), e < 0 ? p.dispatchEvent(c("ps-scroll-" + d)) : e > 0 && p.dispatchEvent(c("ps-scroll-" + h)), n && l(t, u)), t.reach[u] && (e || a) && p.dispatchEvent(c("ps-" + u + "-reach-" + t.reach[u]))
                }(t, i, s, n, a)
            },
            S = {
            ...
            x = function (t) {
                ...
                t.containerWidth = e.clientWidth, t.containerHeight = e.clientHeight, t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (s(e, g.element.rail("x")).forEach(function (t) {
                    return a(t)
                }), e.appendChild(t.scrollbarXRail)), e.contains(t.scrollbarYRail) || (s(e, g.element.rail("y")).forEach(function (t) {
                    return a(t)
            ...
            k = {
                "click-rail": function (t) {
                    t.event.bind(t.scrollbarY, "mousedown", function (t) {
                        ...
                        t.element.scrollTop += i * t.containerHeight, x(t), e.stopPropagation()
                    }), t.event.bind(t.scrollbarX, "mousedown", function (t) {
                        return t.stopPropagation()
                    }), t.event.bind(t.scrollbarXRail, "mousedown", function (e) {
                        var i = e.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left > t.scrollbarXLeft ? 1 : -1;
                        t.element.scrollLeft += i * t.containerWidth, x(t), e.stopPropagation()
                    })
                },
                ...
                keyboard: function (t) {
                    ...
                    t.event.bind(t.ownerDocument, "keydown", function (n) {
                        if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (i() || a())) {
                            ...
                            t.settings.suppressScrollX && 0 !== o || t.settings.suppressScrollY && 0 !== r || (e.scrollTop -= r, e.scrollLeft += o, x(t), function (i, n) {
                                var a = Math.floor(e.scrollTop);
                                if (0 === i) {
                                    if (!t.scrollbarYActive) return !1;
                                    if (0 === a && n > 0 || a >= t.contentHeight - t.containerHeight && n < 0) return !t.settings.wheelPropagation
                                }
                                var s = e.scrollLeft;
                                if (0 === n) {
                ...
                wheel: function (e) {
                    function i(e, i, n) {
                        ...
                        for (var s = e; s && s !== a;) {
                            ...
                            if ([o.overflow, o.overflowX, o.overflowY].join("").match(/(scroll|auto)/)) {
                                ...
                                if (r > 0 && !(0 === s.scrollTop && n > 0 || s.scrollTop === r && n < 0)) return !0;
                    ...
                    function n(t) {
                        ...
                        if (!i(t.target, s, o)) {
                            var r = !1;
                            e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (o ? a.scrollTop -= o * e.settings.wheelSpeed : a.scrollTop += s * e.settings.wheelSpeed, r = !0) : e.scrollbarXActive && !e.scrollbarYActive && (s ? a.scrollLeft += s * e.settings.wheelSpeed : a.scrollLeft -= o * e.settings.wheelSpeed, r = !0) : (a.scrollTop -= o * e.settings.wheelSpeed, a.scrollLeft += s * e.settings.wheelSpeed), x(e), (r = r || function (t, i) {
                                var n = Math.floor(a.scrollTop),
                                    s = 0 === a.scrollTop,
                                    o = n + a.offsetHeight === a.scrollHeight,
                                    r = 0 === a.scrollLeft,
                                    l = a.scrollLeft + a.offsetWidth === a.scrollWidth;
                                return !(Math.abs(i) > Math.abs(t) ? s || o : r || l) || !e.settings.wheelPropagation
                            }(s, o)) && !t.ctrlKey && (t.stopPropagation(), t.preventDefault())
                        }
                    }
                    var a = e.element;
                    void 0 !== window.onwheel ? e.event.bind(a, "wheel", n) : void 0 !== window.onmousewheel && e.event.bind(a, "mousewheel", n)
                },
                touch: function (e) {
                    function i(t, i) {
                        ...
                        } else if (s > o && (t < 0 && a === e.contentWidth - e.containerWidth || t > 0 && 0 === a)) return !0;
                        return !0
                    }

                    function n(t, i) {
                        u.scrollTop -= i, u.scrollLeft -= t, x(e)
                    }
                    ...
                    function r(e, i, n) {
                        ...
                        for (var a = e; a && a !== u;) {
                            ...
                            if ([s.overflow, s.overflowX, s.overflowY].join("").match(/(scroll|auto)/)) {
                                ...
                                if (o > 0 && !(0 === a.scrollTop && n > 0 || a.scrollTop === o && n < 0)) return !0;
                                var r = a.scrollLeft - a.clientWidth;
                                if (r > 0 && !(0 === a.scrollLeft && i < 0 || a.scrollLeft === r && i > 0)) return !0
                            }
                            a = a.parentNode
                        }
                        return !1
                    ...
                    if (S.supportsTouch || S.supportsIePointer) {
                        var u = e.element,
                            ...
                            p = {},
                            f = null;
                        S.supportsTouch ? (e.event.bind(u, "touchstart", o), e.event.bind(u, "touchmove", l), e.event.bind(u, "touchend", c)) : S.supportsIePointer && (window.PointerEvent ? (e.event.bind(u, "pointerdown", o), e.event.bind(u, "pointermove", l), e.event.bind(u, "pointerup", c)) : window.MSPointerEvent && (e.event.bind(u, "MSPointerDown", o), e.event.bind(u, "MSPointerMove", l), e.event.bind(u, "MSPointerUp", c)))
                    }
                }
            },
            $ = function (n, a) {
                var s = this;
                if (void 0 === a && (a = {}), "string" == typeof n && (n = document.querySelector(n)), !n || !n.nodeName) throw new Error("no element is specified to initialize PerfectScrollbar");
                for (var o in this.element = n, n.classList.add(g.main), this.settings = {
                ...
                }(), this.negativeScrollAdjustment = this.isNegativeScroll ? n.scrollWidth - n.clientWidth : 0, this.event = new w, this.ownerDocument = n.ownerDocument || document, this.scrollbarXRail = i(g.element.rail("x")), n.appendChild(this.scrollbarXRail), this.scrollbarX = i(g.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", r), this.event.bind(this.scrollbarX, "blur", l), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
                ...
                this.scrollbarXBottom = parseInt(c.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = u(c.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = u(c.borderLeftWidth) + u(c.borderRightWidth), e(this.scrollbarXRail, {
                    ...
                    display: ""
                }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = i(g.element.rail("y")), n.appendChild(this.scrollbarYRail), this.scrollbarY = i(g.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", r), this.event.bind(this.scrollbarY, "blur", l), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
        ...
        return $.prototype.update = function () {
            this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, e(this.scrollbarXRail, {
                ...
                display: "none"
            }), x(this), C(this, "top", 0, !1, !0), C(this, "left", 0, !1, !0), e(this.scrollbarXRail, {
                display: ""
            }), e(this.scrollbarYRail, {
                display: ""
            }))
        }, $.prototype.onScroll = function (t) {
                    ...
                    value: function () {
                        ...
                        this.$input.on("keyup", function (i) {
                            ...
                            if (e.$autocompleteWrap.empty(), n.length) {
                                for (var a in e.options.data)
                                    if (-1 !== e.options.data[a].toLowerCase().indexOf(n.toLowerCase())) {
                                        var s = t("<li>".concat(e.options.data[a], "</li>"));
                                        e.$autocompleteWrap.append(s)
                                    } var o = e.$autocompleteWrap,
                                    r = e.$autocompleteWrap.find("li"),
                                    l = r.eq(c).outerHeight(),
                                    d = r.eq(c - 1).outerHeight();
                                if (40 === i.which) {
                                    if (c > r.length - 2) return c = -1, r.scrollTop(0), void(u = -45);
                                    c++, u += l, o.scrollTop(u), r.eq(c).addClass("selected")
                                } else 38 === i.which && (c < 1 ? (c = r.length, o.scrollTop(o.prop("scrollHeight")), u = o.prop("scrollHeight") - l) : c--, u -= d, o.scrollTop(u), r.eq(c).addClass("selected"));
    ...
    function (t) {
        t.fn.mdbTreeview = function () {
            ...
            if (e.hasClass("treeview-colorful")) {
                var s = e.find(".treeview-colorful-element"),
                ...
                e.find(".nested").hide(), o.off("click"), o.on("click", function () {
                    ...
                    e.toggleClass("open"), n.removeClass("fa-plus-circle"), n.addClass("fa-minus-circle"), a.removeClass("fa-minus-circle"), a.addClass("fa-plus-circle"), i.hasClass("active") ? i.removeClass("active").slideUp() : i.addClass("active").slideDown()
                }), s.off("click"), s.on("click", function () {
                    var e = t(this);
                    e.hasClass("opened") ? s.removeClass("opened") : (s.removeClass("opened"), e.addClass("opened"))
                })
            }
        }
    }(jQuery);